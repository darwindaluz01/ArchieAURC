...
test('Archie AI Model Setting Gemini 2.5 with and without Advance Thinking', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'Search' }).fill('Gemini 2.5');
    await page.locator('a').filter({ hasText: 'openGemini 2.5 - 2.5, Gemini' }).click();
    ...
    await page.locator('iframe[title="sdkEmbedded"]').contentFrame().getByRole('option', { name: 'Gemini 2.5', exact: true }).click();
    await page.locator('iframe[title="sdkEmbedded"]').contentFrame().getByRole('button', { name: 'Save' }).click();
    console.log('Archie AI Model Gemini 2.5 Selected');
    await page.waitForTimeout(3000);
    ...
    console.log('Ask Archie using AI Model Gemini 2.5');
    await page.waitForTimeout(5000);
    ...
    await page.locator('iframe[title="sdkEmbedded"]').contentFrame().getByRole('button', { name: 'Save' }).click();
    console.log('Archie AI Model Gemini 2.5 with Advance Thinking Selected');
    await page.waitForTimeout(3000);
    ...
    console.log('Archie AI Model Gemini 2.5 Test Completed');
